...
while (turn ~= 0) & (l == 0) & (g == 0) & (s == 0) & (a == 0)
    ...
    for li = 1:6
        for col = 1:4
            ...
            if l == 3
                if game(li, col) == 1
                    ti2 = title('Player 1 Wins !!!  (Press any key for new game)');
                    set(ti2, 'color', 'g')
  ...
  ti = title('Place the cursor on the top of the desired column, then click.');
    ...
    for li = 1:6
        for col = 1:4
            ...
            if l == 3
                if game(li, col) == 1
                    ti2 = title('Player 2 Wins !!!  (Press any key for new game)');
                    set(ti2, 'color', 'm')
                    set(ti2,'FontWeight','bold')
                    set(ti2,'FontSize',19)
                end
        ...
        for rowd2 = 1:3
            ...
            if a == 3
                if game(rowd2, cold2) == 2
                    ti3 = title('Player 2 Wins !!!  (Press any key for new game)');
                    set(ti3, 'color', 'y')
